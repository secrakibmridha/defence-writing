...
\begin{table}[htbp]
    ...
    \begin{tabular}{lccccccc}
        \toprule
        \textbf{Bitumen Type} & \textbf{AC (\%)} & \textbf{Stability (lbs)} & \textbf{Flow (0.25\,mm)} & \textbf{Unit Wt. (lb/cft)} & \textbf{$V_a$ (\%)} & \textbf{VMA (\%)} & \textbf{VFA (\%)} \\
        \midrule
        \multirow{5}{*}{\textbf{Local (ERL)}} 
        & 4.0 & 1813.67 & 9.5 & 145.72 & 7.54 & 16.66 & 54.75 \\
        & 4.5 & 2446.50 & 9.0 & 144.46 & 7.44 & 17.44 & 57.81 \\
        & 5.0 & 2500.00 & 10.0 & 147.28 & 4.92 & 16.47 & 70.15 \\
        & 5.5 & 2438.60 & 11.0 & 150.38 & 2.19 & 15.15 & 85.54 \\
        & 6.0 & 2118.40 & 14.0 & 150.89 & 1.10 & 15.32 & 92.79 \\
        \midrule
        \multirow{5}{*}{\textbf{Imported}} 
        & 4.0 & 1373.81 & 10.0 & 145.58 & 7.42 & 16.55 & 55.17 \\
        & 4.5 & 1069.42 & 11.0 & 144.96 & 7.12 & 17.35 & 58.97 \\
        & 5.0 & 1913.50 & 12.0 & 148.51 & 4.11 & 15.76 & 73.92 \\
        & 5.5 & 2028.64 & 12.0 & 149.70 & 2.64 & 15.53 & 83.01 \\
        & 6.0 & 2182.67 & 15.0 & 151.76 & 0.53 & 14.83 & 96.11 \\
        \bottomrule
    \end{tabular}
    }
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{lcccccc}
        \toprule
        \textbf{Mix Variant} & \textbf{Stability (lbs)} & \textbf{Flow (0.25\,mm)} & \textbf{Unit Wt. (lb/cft)} & \textbf{$V_a$ (\%)} & \textbf{VMA (\%)} & \textbf{VFA (\%)} \\
        \midrule
        Local + Normal & 1958.81 & 10.0 & 149.64 & 3.27 & 15.00 & 78.20 \\
        Imported + Normal & 1119.40 & 17.0 & 146.52 & 4.90 & 16.77 & 70.78 \\
        Local + 20\% Cubical & 2990.55 & 8.5 & 146.64 & 5.20 & 16.70 & 68.86 \\
        Imported + 20\% Cubical & 2070.13 & 12.0 & 150.07 & 2.59 & 14.93 & 82.65 \\
        \bottomrule
    \end{tabular}
    }
\end{table}

\textbf{A. Load Bearing Capacity (Marshall Stability):}
...
\textbf{B. Deformation (Flow Value):}
...
\textbf{C. Required Pavement Thickness:}
