...
Furthermore, emphasizing the regional context of South Asia, Verma and Khare~\cite{verma2024study} investigated the physical properties of conventional crushed rock aggregates used in Indian road construction. They highlighted that aggregate characteristics---such as particle size, shape, and surface texture---are highly significant in determining the strength and serviceability of new-generation bituminous mixtures. Following the MORT\&H specifications, their study demonstrated that fundamental Marshall parameters, including Stability, Flow, VMA, VFB, and Air Voids, are heavily dependent on aggregate particle shapes classified as cubical, rounded, and blade. They concluded that flakiness negatively affects the quality of the bituminous mix, directly validating the necessity of using cubical aggregates to achieve optimal pavement performance.
...
Bitumen is used as a binder for the construction of roads. The main concern of a transport engineer is the durability of the bitumen during the design life. Although it is related to temperature, the effect of aggregate and bitumen mixture on stripping was examined by Bagampadde et al.~\cite{bagampadde2006impact}. They reported that the composition made with lower penetration grade asphalt showed higher durability as it has higher resilient and tensile strength. Moreover, bitumen characteristics like acid number, penetration grade, and molecular size distribution showed less effect on moisture sensitivity.
...
A comparative assessment of the tested binders against the national highway specifications of neighbouring South Asian countries (India, Pakistan, and Nepal) further validates the superiority of the local ERL bitumen, as systematically detailed in Table~\ref{tab:regional_comparison} and illustrated in Figure~\ref{fig:bitumen_regional_comparison}. The subtropical climate of South Asia demands a high Softening Point to resist rutting. The local ERL bitumen, with a Softening Point of $52^{\circ}\text{C}$, comfortably satisfies the stringent requirements of Pakistan's NHA ($48$--$56^{\circ}\text{C}$), Nepal's DOR ($48$--$56^{\circ}\text{C}$), and India's MORT\&H (minimum $47^{\circ}\text{C}$). Conversely, the imported low-cost bitumen exhibited an alarmingly low Softening Point of $41^{\circ}\text{C}$, failing to meet the minimum standards of any of these regional highway authorities.

Furthermore, from a safety and volatility perspective, the Flash Point of the imported bitumen ($218^{\circ}\text{C}$) critically violates the universal minimum safety threshold of $232^{\circ}\text{C}$ mandated consistently across Bangladesh, India, Nepal, and Pakistan. The local ERL bitumen, possessing a Flash Point of $255^{\circ}\text{C}$, significantly exceeds this regional safety benchmark. This regional comparison conclusively demonstrates that the imported low-cost bitumen is fundamentally substandard not only for Bangladesh but for the broader South Asian climatic and operational context.
...
\begin{enumerate}
    \item \textbf{Foundation Level (Subgrade Stabilization):} To address the prevalent issue of weak subgrade soils, it is highly recommended to prioritise chemical stabilisation using cost-effective industrial by-products (e.g., lime or fly ash). This approach substantially increases the California Bearing Ratio (CBR), providing a rigid platform that reduces the required thickness of overlying flexible layers.
    \item \textbf{Surface Level (Optimized Bituminous Mix):} The Roads and Highways Department (RHD) must revise existing material specifications to enforce rigorous quality control on imported bitumen and mandate aggregate shape sorting. Specifically, introducing a specification for a minimum threshold of $20\%$ cubical coarse aggregates paired with local ERL bitumen will fundamentally enhance the interlocking matrix. 
\end{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Rutting and Fatigue Evaluation:} Conducting the Hamburg Wheel Tracking Test (AASHTO T 324) to evaluate empirical rutting depth progression, and the Four-Point Bending Beam Fatigue Test (AASHTO T 321) to assess the fatigue cracking resistance of the bituminous mixtures under cyclic traffic loading.
    \item \textbf{Evaluation of Polymer Modified Bitumen (PMB):} While this study evaluated the baseline performance of neat local and imported binders, future research should investigate the enhancement of these base bitumens by adding 5\% SBS (Styrene-Butadiene-Styrene) polymer to produce Polymer Modified Bitumen (PMB), in accordance with LGED specifications. A comparative study on PMB would be highly valuable to evaluate the extent to which polymer modification improves the load-bearing capacity (rutting resistance) and long-term durability (fatigue life) of flexible pavements under Bangladesh's severe climatic and heavy traffic conditions.
    \item \textbf{Performance Enhancement of Imported Bitumen:} Given the significant supply-demand gap of locally produced ERL bitumen, importing low-cost bitumen remains an unavoidable reality for Bangladesh. Therefore, a highly practical area for future research is the performance enhancement of these imported binders to meet national road construction standards. Future studies should investigate the modification of imported bitumen using additives such as 5\% SBS polymer (to produce PMB), crumb rubber, or waste plastics. Such research would aim to determine the optimal modification techniques required to elevate the structural and rheological properties of imported bitumen, enabling it to match or exceed the performance of local ERL bitumen while maintaining cost-effectiveness.
\end{itemize}
