...
\begin{enumerate}[label=\roman*.]
    \item To compare the physical properties (penetration, softening point, ductility, viscosity, specific gravity, and flash point) of local and imported 60/70 penetration-grade bitumen.
    ...
    \item To assess the structural performance of four mix combinations in terms of Marshall stability, flow, indirect tensile strength (ITS), and retained stability after moisture conditioning.
...
\begin{table}[htbp]
    ...
    \begin{tabular}{@{}llcc@{}}
        \toprule
        \textbf{Property} & \textbf{Test Standard} & \textbf{Specification} & \textbf{Test Result} \\
        \midrule
        Penetration at 25$^{\circ}$C (dmm) & ASTM D5 & 60--70 & XX \\
        Softening Point ($^{\circ}$C) & ASTM D36 & 49--56 & XX \\
        Ductility at 25$^{\circ}$C (cm) & ASTM D113 & $\geq$75 & XX \\
        Kinematic Viscosity at 135$^{\circ}$C (cSt) & ASTM D2170 & $\geq$300 & XX \\
        Specific Gravity at 25$^{\circ}$C & ASTM D70 & 0.97--1.02 & XX \\
        Flash Point ($^{\circ}$C) & ASTM D92 & $\geq$230 & XX \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{@{}llcc@{}}
        \toprule
        \textbf{Property} & \textbf{Test Standard} & \textbf{Specification Limit} & \textbf{Test Result} \\
        \midrule
        Los Angeles Abrasion Value (\%) & ASTM C131 & $\leq$30 & XX \\
        Aggregate Impact Value (\%) & IS 2386 Part IV & $\leq$27 & XX \\
        Aggregate Crushing Value (\%) & IS 2386 Part IV & $\leq$30 & XX \\
        Specific Gravity (Coarse) & ASTM C127 & 2.5--2.9 & XX \\
        Specific Gravity (Fine) & ASTM C128 & 2.5--2.9 & XX \\
        Water Absorption (\%) & ASTM C127 & $\leq$2 & XX \\
        Flakiness Index (\%) & IS 2386 Part I & $\leq$30 & XX \\
        Elongation Index (\%) & IS 2386 Part I & $\leq$30 & XX \\
        \bottomrule
    \end{tabular}
\end{table}
...
\subsubsection{Indirect Tensile Strength (ITS) Test}

The Indirect Tensile Strength (ITS) test was performed in accordance with ASTM D6931 (Standard Test Method for Indirect Tensile Strength of Asphalt Mixtures). Three specimens per mix were tested under horizontal diametral compression. The specimens were loaded along the vertical diametral plane at a constant rate of deformation until failure occurred. The ITS value was calculated from the maximum load at failure, the specimen diameter, and the specimen height.

\subsubsection{Retained Stability Test (Moisture Susceptibility)}

Moisture susceptibility was assessed using the modified Marshall immersion test. For each mix combination, three additional specimens were prepared and immersed in a water bath maintained at 60$^{\circ}$C for 24 hours. Following immersion, the specimens were tested for Marshall stability under the standard conditions described in Section~3.6.1. The retained stability was calculated as:

\begin{equation}
    \text{Retained Stability (\%)} = \frac{\text{Stability after 24-hour immersion}}{\text{Stability under normal conditions}} \times 100
    \label{eq:retained}
\end{equation}

A retained stability value of 75\% or above is considered acceptable per RHD specifications, indicating adequate resistance of the mix to moisture-induced damage.
...
Table~\ref{tab:test_matrix} summarises the complete experimental test matrix adopted in this study. A total of 36 Marshall specimens were prepared across the four mix combinations and three test categories.
...
\begin{table}[htbp]
    ...
    \begin{tabular}{@{}lccc@{}}
        ...
        \midrule
        Marshall Stability \& Flow (Normal) & 3 & 4 & 12 \\
        Indirect Tensile Strength (ITS) & 3 & 4 & 12 \\
        Retained Stability (24-hr Immersion) & 3 & 4 & 12 \\
        \midrule
        \textbf{Grand Total} & & & \textbf{36} \\
        \bottomrule
    \end{tabular}
\end{table}
