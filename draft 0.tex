...
\textbf{Overall Performance Assessment (Objective iv):}
In direct fulfillment of Objective (iv), the performance of all four mix combinations was systematically assessed across Marshall stability, flow, and volumetric properties. The experimental outcomes, tabulated in Table~\ref{tab:mix_data} and comprehensively illustrated in Figure~\ref{fig:performance_assessment}, reveal profound interaction effects between binder source and aggregate shape. From a volumetric perspective, the inclusion of 20\% cubical aggregates with the imported binder (Mix-4) resulted in a dense matrix with critically low air voids (2.59\%) and excessively high Voids Filled with Asphalt (82.65\%), posing a severe risk of bleeding and plastic deformation under heavy traffic loading. In contrast, the conventional mixes with normal aggregates (Mix-1 and Mix-2) maintained volumetric properties within standard tolerances but lacked optimal structural capacity. The synergetic combination of local ERL bitumen and 20\% cubical aggregates (Mix-3) achieved an exceptional balance, delivering maximum stability and optimal flow while sustaining adequate Voids in Mineral Aggregate (16.70\%) to accommodate the binder, thereby ensuring long-term durability without compromising shear resistance.
